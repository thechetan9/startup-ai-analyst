...
class Settings(BaseSettings):
    ...
    # Google Cloud
    google_cloud_project_id: str = "my-project-genai-464305"
    ...
    # Firebase
    firebase_project_id: str = "my-project-genai-464305"
    firebase_api_key: str = "dummy-key"
    firebase_auth_domain: str = "my-project-genai-464305.firebaseapp.com"
    firebase_storage_bucket: str = "my-project-genai-464305.appspot.com"
